...
| `components/ui/` | shadcn/ui design system + game visuals | `button.tsx`, `card.tsx`, `dialog`, `toast.tsx`, `button-particle-portal.tsx` (action-button click burst provider/layer — particles above panel content, below `CooldownButton`), `mist-background.tsx`, `cloud-shader.tsx`, `starship-shader.tsx` (WebGL2 fullscreen starship fragment shader), `limelight-nav.tsx` |
