...
| `client/src/game/demoLimit.ts` | Shared wooden-hut demo limit + `processDemoLimit()` + `isDemoPlayFrozen()` (loop and actions stay frozen after the cap). |
