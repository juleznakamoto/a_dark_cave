...
| `supabase/` | SQL migrations + edge function (`functions/save-game/`) for Postgres/RLS. Notable: `024` deep-merge saves, `025` permanent tools/weapons/books protection, `029` wholesale-replace of delete-semantic execution/expedition maps (stops ghost re-completions on reload). |
