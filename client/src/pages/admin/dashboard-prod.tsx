...
export default function AdminDashboardProd() {
  ...
  const supabase = useMemo(() => {
    ...
    if (!supabaseUrl || !supabaseAnonKey) {
      throw new Error('PROD Supabase configuration is missing.');
    }
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-background">
        <div className="text-foreground">Loading PROD Dashboard...</div>
      </div>
    );
  }
        ...
        <ScrollArea className="h-full">
          <div className="space-y-8 pr-4">
            <div className="flex justify-between items-center">
              <h1 className="text-4xl font-bold">Admin Dashboard (PROD)</h1>
