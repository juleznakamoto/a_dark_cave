    ...
    <div className="fixed inset-0 bg-black text-white overflow-hidden">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center min-h-screen">
        ...
        <ParticleButton
          ...
          className={`animate-fade-in-button bg-transparent border-none text-gray-300/90 hover:bg-transparent text-lg px-8 py-4 fire-hover z-[99999] ${showParticles ? 'fire-active' : ''}`}
