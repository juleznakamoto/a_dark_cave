    ...
    <TooltipWrapper
      tooltip={
        <div className="text-xs space-y-1 max-w-[200px]">
          ...
          <p>
            Hit the goal exactly to lock your total — the obsessed gambler keeps
            rolling until the round resolves.
          </p>
          <p>
            You and he take turns rolling <strong>one die</strong> each.
          </p>
          <p>
            After both stand: higher total wins. If tied <strong>under</strong>{" "}
            the goal, the goal goes up by {GOAL_INCREMENT}.
          </p>
