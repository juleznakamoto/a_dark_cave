...
export default function GameContainer() {
  ...
  return (
    <div className="fixed inset-0 bg-background text-foreground flex flex-col">
      ...
      {isPaused && (
        <div
          className="fixed inset-0 bg-black/70 z-40 pointer-events-auto overlay-fade-in"
          style={{ bottom: "45px" }}
        />
      )}
      ...
      {idleModeDialog.isOpen && (
        <div
          className="fixed inset-0 bg-black/0 z-40 pointer-events-auto overlay-fade-in"
          style={{ bottom: "45px" }}
        />
      )}
