...
export default function GameContainer() {
  ...
  return (
    <div className="h-screen w-screen max-w-full bg-background text-foreground flex flex-col overflow-hidden">
      <main className="flex-1 p-6 overflow-hidden flex flex-col max-w-full">
        ...
        <div className="flex flex-1 min-h-0 max-w-full overflow-hidden">
          ...
          <div className="w-96 flex-shrink-0 border-t border-r overflow-y-auto">
            <GameTabs />
          </div>

          {/* Right Content Area with Horizontal Tabs and Actions */}
          <section className="flex-1 min-w-0 pl-0 flex flex-col overflow-hidden">
            {/* Horizontal Game Tabs */}
            <nav className="border-t border-border pl-6 mb-4 pt-4 flex-shrink-0">
              {useLimelightNav ? (
            ...
            {/* Action Panels */}
            <div className="flex-1 overflow-y-auto overflow-x-hidden pl-6 max-w-full">
