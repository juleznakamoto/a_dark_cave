  ...
  return (
    <ProfileMenuProvider>
      ...
      >
        ...
        <main className="flex-1 pb-0 flex flex-col md:grid md:w-full md:grid-cols-[minmax(14rem,26rem)_minmax(22rem,1fr)_minmax(20rem,28rem)] min-h-0 overflow-hidden">
