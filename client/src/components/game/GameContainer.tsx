...
export default function GameContainer() {
  ...
  return (
    <div className="fixed inset-0 bg-background text-foreground flex flex-col">
      ...
      {isPaused && (
        <div
          className="fixed top-0 left-0 right-0 bg-black/80 z-40 pointer-events-auto overlay-fade-in"
          style={{ bottom: "45px" }}
        />
      )}
      ...
      {idleModeDialog.isOpen && (
        <div
          className="fixed top-0 left-0 right-0 bg-black/100 z-40 pointer-events-auto overlay-fade-in"
          style={{ bottom: "45px" }}
        />
      )}
      ...
      <main className="flex-1 pb-0 flex flex-col md:flex-row min-h-0 overflow-hidden">
        ...
        <div className="w-full pl-2 pr-2 md:w-[26rem] border-t md:border-r overflow-hidden">
          <GameTabs />
        </div>
