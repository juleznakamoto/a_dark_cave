                ...
                {useLimelightNav ? (
                  ...
                  <>
                    ...
                    <div className="flex w-full max-w-full flex-nowrap items-end gap-x-1.5 md:gap-x-2">
                      {/* flex, not inline-flex: this row is a block-level flex item.
                          flex-1 fills leftover width so the trader stays on the right,
                          and overflow scrolls inside the row. */}
                      <div
                        ref={tabButtonRowRef}
                        className="flex min-w-0 flex-1 flex-nowrap items-end gap-x-1.5 overflow-x-auto scrollbar-hide md:gap-x-2"
                      >
                        <button
