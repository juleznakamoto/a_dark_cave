  ...
  return (
    <>
      {isCubeEvent ? (
        ...
        >
          <DialogContent className={`z-[60] gap-2 [--adc-dialog-max-w:28rem] [&>button]:hidden ${isMadnessEvent ? 'border-2 border-violet-600 shadow-2xl p-6  max-h-[19rem] flex flex-col overflow-visible' : ''}`}>
            {isMadnessEvent && (
