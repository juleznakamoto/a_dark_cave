  ...
  return (
    <>
      {isCubeEvent ? (
        ...
        >
          <DialogContent className={`w-[95vw] sm:max-w-md [&>button]:hidden ${isMadnessEvent ? 'border-2 border-red-500 p-6 h-[19rem] max-h-[19rem] flex flex-col overflow-visible z-[100] bg-transparent madness-dialog-glow' : ''}`}>
            <DialogHeader>
