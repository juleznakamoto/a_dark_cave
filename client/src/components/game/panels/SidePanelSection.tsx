    ...
    const labelContent = (
      ...
      >
        {item.icon !== undefined && (
          <span
            className={cn(
              // Same slot for every glyph so a wide ☆ cannot push the label right.
              "font-noto-symbols-2 inline-flex w-[1em] shrink-0 items-center justify-center leading-none",
              item.iconColor,
            )}
          >
            {item.icon}
