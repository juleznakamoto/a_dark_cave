...
const DEFAULT_CLASS =
  "inline-block shrink-0 bg-current text-white opacity-100 [mask-size:contain] [mask-repeat:no-repeat] [mask-position:center] [-webkit-mask-size:contain] [-webkit-mask-repeat:no-repeat] [-webkit-mask-position:center]";
