...
export default function ResourceChangeNotification({ resource, changes }: ResourceChangeNotificationProps) {
  ...
  return (
    <div className="pointer-events-none absolute inset-y-0 right-0 flex w-[3rem] items-center justify-end">
      <div
        className={`
          rounded-sm bg-background px-1 text-right text-xs font-mono font-bold tabular-nums leading-none
