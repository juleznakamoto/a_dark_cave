          ...
          {showFocusButton && (
            <div className="relative inline-block pb-1 text-xs font-medium text-foreground ml-2">
              ...
              {focusState && focusState.points > 0 && (
                <div
                  className="game-corner-badge-digit absolute -top-[9px] right-[-9px] flex items-center justify-center w-5 h-5 bg-teal-950 rounded-full z-[20] pointer-events-none"
                >
                  {focusState.points}
                </div>
              )}
