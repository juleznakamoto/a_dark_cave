...
const CALLOUT_BASE =
  "absolute z-[1] flex appearance-none [-webkit-appearance:none] rounded-md bg-primary px-2 py-1.5 text-2xs font-semibold leading-none tracking-wide text-primary-foreground shadow-md transition-opacity duration-300";
