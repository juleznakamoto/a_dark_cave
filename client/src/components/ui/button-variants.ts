...
export const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-xs font-normal ring-offset-background transition-[color,transform] duration-100 ease-out active:scale-[0.97] focus-visible:outline-none cursor-pointer disabled:cursor-default aria-disabled:cursor-default disabled:pointer-events-none disabled:opacity-50 select-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
