...
/** Official itch.io bag mark (press-kit logo-only), brand color #fa5c5c. */
function ItchIoLogo({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
                  ...
                  <div className="flex flex-wrap justify-center gap-3 sm:gap-4 items-center">
                    ...
                    {buttons?.rateItch && (
                      <button
                        ...
                        className={END_SCREEN_LINK_BUTTON_CLASS}
                      >
                        <ItchIoLogo className="h-3.5 w-3.5 shrink-0 text-[#fa5c5c]" />
