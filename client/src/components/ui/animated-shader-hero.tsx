...
#define PRIMARY_COLOR vec3(1.0, 0.6, 0.2)      // Bright orange fire
#define SECONDARY_COLOR  vec3(1.0, 0.4, 0.0)      // Orange-red
#define TERTIARY_COLOR vec3(1.0, 0.8, 0.0)     // Yellow-orange
