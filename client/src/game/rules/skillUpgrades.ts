...
/** Extra crit damage % from Feral Howl when Brute Hound is in the fellowship. */
export function getFeralHowlCritDamageBonusPercent(state: {
...
export const SLEEP_LENGTH_UPGRADES = [
  ...
  { level: 1, hours: 4, cost: 100, currency: "gold" },
  { level: 2, hours: 6, cost: 250, currency: "gold" },
  { level: 3, hours: 8, cost: 500, currency: "gold" },
  { level: 4, hours: 10, cost: 750, currency: "gold" },
  { level: 5, hours: 12, cost: 1000, currency: "gold" },
  { level: 6, hours: 14, cost: 1250, currency: "gold" },
  { level: 7, hours: 16, cost: 1500, currency: "gold" },
  { level: 8, hours: 18, cost: 1750, currency: "gold" },
];

export const SLEEP_INTENSITY_UPGRADES = [
  { level: 0, percentage: 10, cost: 0, currency: null },
  { level: 1, percentage: 15, cost: 100, currency: "gold" },
  { level: 2, percentage: 20, cost: 250, currency: "gold" },
  { level: 3, percentage: 25, cost: 500, currency: "gold" },
  { level: 4, percentage: 30, cost: 750, currency: "gold" },
  { level: 5, percentage: 35, cost: 1000, currency: "gold" },
  { level: 6, percentage: 40, cost: 1250, currency: "gold" },
  { level: 7, percentage: 45, cost: 1500, currency: "gold" },
  { level: 8, percentage: 50, cost: 1750, currency: "gold" },
];
...
export const CROWS_EYE_UPGRADES = [
  ...
  { level: 1, doubleChance: 1.5, cost: 250, currency: "gold" },
  { level: 2, doubleChance: 3, cost: 500, currency: "gold" },
  { level: 3, doubleChance: 5, cost: 750, currency: "gold" },
  { level: 4, doubleChance: 7.5, cost: 1000, currency: "gold" },
  { level: 5, doubleChance: 10, cost: 1250, currency: "gold" },
];
