...
const TIER_CONDITIONS = {
  veryEarly: (state: GameState) => state.buildings.woodenHut >= 3 && state.buildings.woodenHut <= 6,
  early: (state: GameState) => state.buildings.woodenHut >= 5 && state.buildings.woodenHut <= 9,
  mid1: (state: GameState) => state.buildings.woodenHut >= 7 && state.buildings.stoneHut <= 5,
  mid2: (state: GameState) => state.buildings.stoneHut >= 3 && state.buildings.stoneHut <= 8,
  end: (state: GameState) => state.buildings.stoneHut >= 7,
  sellEarly: (state: GameState) => state.buildings.woodenHut >= 4 && state.buildings.woodenHut <= 9,
};

// Define trade configurations based on progression tiers
const buyTrades = [
  // Very Early tier
  createBuyTrade("buy_food_250_early", "food", 250, TIER_CONDITIONS.veryEarly, ["wood", "stone", "silver", "gold"]),
  createBuyTrade("buy_wood_250_early", "wood", 250, TIER_CONDITIONS.veryEarly, ["food", "stone", "silver", "gold"]),
  createBuyTrade("buy_stone_250_early", "stone", 250, TIER_CONDITIONS.veryEarly, ["food", "wood", "silver", "gold"]),
  createBuyTrade("buy_leather_50_early", "leather", 50, TIER_CONDITIONS.veryEarly, ["wood", "stone", "food", "steel", "silver", "gold"]),

  // Early tier
  createBuyTrade("buy_food_500_early", "food", 500, TIER_CONDITIONS.early, ["wood", "stone", "silver", "gold"]),
  createBuyTrade("buy_wood_500_early", "wood", 500, TIER_CONDITIONS.early, ["food", "stone", "silver", "gold"]),
  createBuyTrade("buy_stone_500_early", "stone", 500, TIER_CONDITIONS.early, ["food", "wood", "silver", "gold"]),
  createBuyTrade("buy_leather_50_early", "leather", 100, TIER_CONDITIONS.early, ["wood", "stone", "food", "steel", "silver", "gold"]),
  createBuyTrade("buy_steel_50_early", "steel", 50, TIER_CONDITIONS.early, ["wood", "stone", "food", "leather", "silver", "gold"]),

  // Mid 1 tier
  createBuyTrade("buy_food_1000_mid1", "food", 1000, TIER_CONDITIONS.mid1, ["wood", "stone", "steel", "silver", "gold"]),
  createBuyTrade("buy_wood_1000_mid1", "wood", 1000, TIER_CONDITIONS.mid1, ["food", "stone", "steel", "silver", "gold"]),
  createBuyTrade("buy_stone_500_mid1", "stone", 500, TIER_CONDITIONS.mid1, ["wood", "food", "steel", "silver", "gold"]),
  createBuyTrade("buy_leather_150_mid1", "leather", 150, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "steel", "silver", "gold"]),
  createBuyTrade("buy_steel_150_mid1", "steel", 150, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "silver", "gold"]),

  // Mid 2 tier
  createBuyTrade("buy_food_2000_mid2", "food", 2000, TIER_CONDITIONS.mid2, ["wood", "stone", "leather", "steel", "gold"]),
  createBuyTrade("buy_wood_2000_mid2", "wood", 2000, TIER_CONDITIONS.mid2, ["food", "stone", "leather", "steel", "gold"]),
  createBuyTrade("buy_stone_1000_mid2", "stone", 1000, TIER_CONDITIONS.mid2, ["wood", "food", "leather", "steel", "gold"]),
  createBuyTrade("buy_leather_100_mid2", "leather", 100, TIER_CONDITIONS.mid2, ["wood", "stone", "food", "steel", "gold"]),
  createBuyTrade("buy_steel_250_mid2", "steel", 250, TIER_CONDITIONS.mid2, ["wood", "stone", "food", "leather", "gold"]),

  // End tier
  createBuyTrade("buy_food_2000_end", "food", 2000, TIER_CONDITIONS.end, ["wood", "stone", "leather", "steel", "gold"]),
  createBuyTrade("buy_stone_2500_end", "stone", 2500, TIER_CONDITIONS.end, ["wood", "food", "leather", "steel", "gold"]),
  createBuyTrade("buy_steel_500_end", "steel", 500, TIER_CONDITIONS.end, ["wood", "stone", "food", "leather", "gold"]),
];

const sellTrades = [
  // Early tier
  createSellTrade("sell_food_100_early", "food", 100, TIER_CONDITIONS.sellEarly, ["wood", "stone", "leather", "steel", "gold"]),
  createSellTrade("sell_bones_100_early", "bones", 100, TIER_CONDITIONS.sellEarly, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_fur_100_early", "fur", 100, TIER_CONDITIONS.sellEarly, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_wood_250_early", "wood", 250, TIER_CONDITIONS.sellEarly, ["food", "stone", "leather", "steel", "gold"]),
  createSellTrade("sell_stone_100_early", "stone", 100, TIER_CONDITIONS.sellEarly, ["wood", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_iron_100_early", "iron", 100, TIER_CONDITIONS.sellEarly, ["wood", "stone", "food", "leather", "steel", "gold"]),

  // Mid 1 tier
  createSellTrade("sell_food_250_mid1", "food", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "leather", "steel", "gold"]),
  createSellTrade("sell_bones_250_mid1", "bones", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_fur_250_mid1", "fur", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_wood_250_mid1", "wood", 250, TIER_CONDITIONS.mid1, ["food", "stone", "leather", "steel", "gold"]),
  createSellTrade("sell_stone_250_mid1", "stone", 250, TIER_CONDITIONS.mid1, ["wood", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_iron_250_mid1", "iron", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_coal_250_mid1", "coal", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_sulfur_250_mid1", "sulfur", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "steel", "gold"]),
  createSellTrade("sell_leather_50_mid1", "leather", 50, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "steel", "gold"]),
  createSellTrade("sell_steel_250_mid1", "steel", 250, TIER_CONDITIONS.mid1, ["wood", "stone", "food", "leather", "gold"]),

  // Mid 2 tier
  createSellTrade("sell_food_500_mid2", "food", 500, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_bones_250_mid2", "bones", 250, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_fur_250_mid2", "fur", 250, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_wood_500_mid2", "wood", 500, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_stone_500_mid2", "stone", 500, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_iron_500_mid2", "iron", 500, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_coal_500_mid2", "coal", 500, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_sulfur_500_mid2", "sulfur", 500, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_obsidian_50_mid2", "obsidian", 50, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_adamant_50_mid2", "adamant", 50, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_moonstone_50_mid2", "moonstone", 50, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_leather_100_mid2", "leather", 100, TIER_CONDITIONS.mid2, ["silver", "gold"]),
  createSellTrade("sell_steel_250_mid2", "steel", 250, TIER_CONDITIONS.mid2, ["silver", "gold"]),

  // End tier
  createSellTrade("sell_food_500_end", "food", 500, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_bones_250_end", "bones", 250, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_fur_250_end", "fur", 250, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_wood_500_end", "wood", 500, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_stone_500_end", "stone", 500, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_iron_500_end", "iron", 500, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_coal_500_end", "coal", 500, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_sulfur_500_end", "sulfur", 500, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_obsidian_100_end", "obsidian", 100, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_adamant_100_end", "adamant", 100, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_moonstone_100_end", "moonstone", 100, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_leather_250_end", "leather", 250, TIER_CONDITIONS.end, ["silver", "gold"]),
  createSellTrade("sell_steel_250_end", "steel", 250, TIER_CONDITIONS.end, ["silver", "gold"]),
];
