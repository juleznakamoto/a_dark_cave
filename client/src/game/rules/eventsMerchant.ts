...
const resourceTrades = [
  ...
  },
  {
    ...
    costs: [
      { resource: "steel", amounts: [1000] },
      { resource: "wood", amounts: [10000] },
      { resource: "stone", amounts: [6000] },
      { resource: "fur", amounts: [10000] },
      { resource: "leather", amounts: [7000] },
      { resource: "food", amounts: [10000] },
      { resource: "obsidian", amounts: [200] },
      { resource: "adamant", amounts: [40] },
    ],
  },
  {
    id: "trade_silver_500",
