...
const ATTACK_WAVE_DEFINITIONS: Record<AttackWaveId, AttackWaveDefinition> = {
  ...
  fourthWave: {
    ...
    health: { base: 550, cruelBonus: 100 },
  },
  fifthWave: {
    ...ATTACK_WAVE_TIMER_DEFAULTS,
