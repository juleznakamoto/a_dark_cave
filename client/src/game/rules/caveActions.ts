...
export const caveActions: Record<string, Action> = {
  ...
  exploreRuins: {
    ...
    effects: {
      ...
      "resources.bloodstone": { probability: 0.08, value: "random(1,2)" },
  ...
  exploreTemple: {
    ...
    effects: {
      ...
      "resources.bloodstone": { probability: 0.12, value: "random(1,3)" },
      "resources.frostglas": { probability: 0.1, value: "random(1,2)" },
  ...
  exploreCitadel: {
    ...
    effects: {
      ...
      "resources.bloodstone": { probability: 0.15, value: "random(2,4)" },
      "resources.frostglas": { probability: 0.12, value: "random(1,3)" },
