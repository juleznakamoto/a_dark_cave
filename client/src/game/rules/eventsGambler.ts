...
export const gamblerEvents: Record<string, GameEvent> = {
  gambler: {
    ...
    message:
      "A gambler sits cross-legged by the fire, eyes fixed on the dice as if the rest of the world has gone quiet. 'Place your bet,' he breathes with a crooked grin, 'and let's find out who the better player is.'",
    priority: 2,
    repeatable: true,
    showAsTimedTab: true,
