...
export const wanderingCollectorEvents: Record<string, GameEvent> = {
  wandering_collector: {
    ...
    choices: [
      {
        id: "collector_interaction",
        label: "Speak with the collector",
        effect: (state: GameState) => {
            ...
            effect: (innerState: GameState) => {
              const newState: Partial<GameState> = {
                resources: {
                  ...
                  gold: (innerState.resources.gold || 0) + 150,
                },
              };
          ...
          return {
            _timedTabEvent: {
              ...
              timestamp: Date.now(),
              message: "The collector looks at your items. 'What will you give me?'",
              title: "The Wandering Collector",
              choices: choices,
