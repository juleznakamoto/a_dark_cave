...
export const toolEffects: Record<string, EffectDefinition> = {
    ...
    bonuses: {
      actionBonuses: {
        mining: {
          resourceMultiplier: 2.0,
          probabilityBonus: {
            silver: 0.02, // 2% chance to find silver
          },
        },
      },
    },
  ...
  bone_saw: {
    id: "bone_saw",
    name: "Bone Saw",
    description: "The necromancer's tool, unnaturally efficient at butchering",
    bonuses: {
      actionBonuses: {
        hunter: {
          resourceBonus: {
...
export const clothingEffects: Record<string, EffectDefinition> = {
  ...
  ring_of_clarity: {
    ...
    description: "Ring carved out of very clear crystal",
    bonuses: {
      generalBonuses: {
        madness: -5,
      },
  ...
  flames_touch_enhanced: {
    ...
    description: "Crafting costs are greatly reduced",
    bonuses: {
      generalBonuses: {
  ...
  sealed_chest: {
    id: "sealed_chest",
    name: "Sealed Chest",
    description: "Very sturdy chest you are not able to open",
    bonuses: {},
  },
};
