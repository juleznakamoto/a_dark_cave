...
export const choiceEvents: Record<string, GameEvent> = {
  ...
  wanderingAlchemist: {
    ...
    condition: (state: GameState) =>
      state.cruelMode &&
      state.story.seen.hasAshfireBomb &&
      !state.story.seen.wanderingAlchemistEvent,
    triggerType: "resource",
    timeProbability: 5,
    title: "The Wandering Alchemist",
    message:
      "A mysterious alchemist in dark robes arrives at your village. His eyes gleam with dangerous knowledge. 'I can teach you to craft a bomb of extreme power,' he whispers, 'a weapon that tears reality itself. But such knowledge comes at a price.'",
    triggered: false,
    priority: 4,
    repeatable: false,
    choices: [
      {
        ...
        effect: (state: GameState) => {
          ...
          return {
            ...
            _logMessage:
              "The alchemist accepts your payment. He teaches you the dark art of crafting void bombs, weapons that harness the power of the void itself. 'Use them wisely,' he warns before vanishing into the shadows.",
          };
        },
      },
      {
      ...
      },
      {
        ...
        effect: (state: GameState) => {
          return {
            ...
            _logMessage:
              "You refuse the alchemist's dangerous knowledge. He gives you a knowing smile before disappearing into the mist, leaving behind only an unsettling silence.",
          };
        },
      },
    ],
