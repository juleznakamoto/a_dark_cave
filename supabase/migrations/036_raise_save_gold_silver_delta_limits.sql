-- Raise per-save anti-cheat deltas: gold 2000->5000, silver 5000->10000.
-- Late-game merchant sells / investment payouts routinely exceed the old gold cap
-- and trap legitimate players in a reject loop (cloud gold frozen, local keeps growing).
-- Body is save_game_with_analytics from migration 030 with only those thresholds changed.
