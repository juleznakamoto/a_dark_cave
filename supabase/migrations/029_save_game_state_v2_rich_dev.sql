...
--
-- DEV-ONLY: no-ops unless app_config.environment = 'development'.
-- Do not apply this migration to production until cutover is intentional.
-- Client also gates dual-write behind import.meta.env.DEV.
